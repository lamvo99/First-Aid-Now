...
class AppColors {
  ...
  static const Color PRIMARY_BASE =  Color(0xff3563E9);
  ...
  */
  ...
  static const Color primary100 = Color(0xffE8F0FE); // Rất nhạt - cho nền hoặc hiệu ứng subtle
  static const Color primary200 = Color(0xffD2E3FC); // Nhạt - cho trạng thái hover nhẹ
  static const Color primary300 = Color(0xffAACBFA); // Sáng hơn - cho các phần không active
  static const Color primary400 = Color(0xff72A8F8); // Trung bình nhạt - cho nút phụ hoặc icon
  static const Color primary500 = Color(0xff4285F4); // Màu primary chính - cho nút chính và yếu tố quan trọng
  static const Color primary600 = Color(0xff3B78E2); // Tối hơn - cho trạng thái hover của nút chính
  static const Color primary700 = Color(0xff3367D6); // Tối - cho trạng thái active hoặc pressed
  static const Color primary800 = Color(0xff2A56C0); // Rất tối - cho chữ hoặc accent mạnh
  static const Color primary900 = Color(0xff1E3E8C); // Tối nhất - cho các accent hiếm khi dùng
