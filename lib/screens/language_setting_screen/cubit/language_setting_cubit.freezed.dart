...
class __$$InitialImplCopyWithImpl<$Res>
    extends _$LanguageSettingStateCopyWithImpl<$Res, _$InitialImpl>
...
class _$InitialImpl with DiagnosticableTreeMixin implements _Initial {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'LanguageSettingState(languageCode: $languageCode, errorMessage: $errorMessage, status: $status)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'LanguageSettingState'))
...
abstract class _Initial implements LanguageSettingState {
